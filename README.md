...
- `docs/analisi_mercato/` - Analisi di mercato introduzione, teoria, frameworks
- `docs/fattibilita/` - Studio di fattibilità del progetto (README.md, excel, requirements)
...
In questa fase è fondamentale raccogliere i dati che saranno di supporto alla fase di braninstorming e alla definizione del progetto.

# 2. Fase Brainstorming - Oct 2026
...
# 4. Oct - Gestione del Codice Sorgente
...
# 5. Nov - Compilare almeno due requirements
...
# 7. Dec - Studio Documentazione Economico/Finanziaria
